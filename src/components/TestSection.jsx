            ...
            <section className="text-center mt-24 max-w-7xl mx-auto pt-4 p-8 sm:pt-8">
                ...
                <div className="mt-12 grid grid-cols-1 md:grid-cols-2 gap-12">
                    <div className="bg-gray-900 p-8 rounded-lg shadow-lg flex items-center gap-6">
                        <img src="profile/Profile2.jpg" alt="User image" className='w-[52px] h-[52px] rounded-full border-2 border-purple-400 object-cover' />
                    ...
                    <div className="bg-gray-900 p-8 rounded-lg shadow-lg flex items-center gap-6">
                        <img src="profile/Profile3.jpg" alt="User image" className='w-[52px] h-[52px] rounded-full border-2 border-blue-400 object-cover' />
                        <div className='text-left'>
